...
-- Started on 2017-10-15 23:28:03
...
--
-- TOC entry 2310 (class 1262 OID 16384)
...
--
-- TOC entry 2311 (class 1262 OID 16384)
-- Dependencies: 2310
...
--
-- TOC entry 2091 (class 2604 OID 16454)
...
--
-- TOC entry 2093 (class 2604 OID 16455)
...
--
-- TOC entry 2092 (class 2604 OID 16456)
...
--
-- TOC entry 2094 (class 2604 OID 16457)
...
--
-- TOC entry 2096 (class 2604 OID 16458)
...
--
-- TOC entry 2097 (class 2604 OID 16459)
...
--
-- TOC entry 2098 (class 2604 OID 16460)
...
--
-- TOC entry 2099 (class 2604 OID 16461)
...
--
-- TOC entry 2100 (class 2604 OID 16463)
...
--
-- TOC entry 2101 (class 2604 OID 16464)
...
--
-- TOC entry 2102 (class 2604 OID 16465)
...
--
-- TOC entry 2278 (class 0 OID 16388)
-- Dependencies: 188
...
--
-- TOC entry 2282 (class 0 OID 16403)
-- Dependencies: 192
...
--
-- TOC entry 2280 (class 0 OID 16398)
-- Dependencies: 190
...
--
-- TOC entry 2284 (class 0 OID 16408)
-- Dependencies: 194
-- Data for Name: projects; Type: TABLE DATA; Schema: process; Owner: postgres
--

INSERT INTO projects VALUES (1, 'Project 1', 'This is an updated project from web app', 1, 2, '{0,2,1}', '{0,1,2}');
INSERT INTO projects VALUES (2, 'Project 2', 'Testing', 0, 1, '{0,1,2}', '{2,0,1}');


--
-- TOC entry 2286 (class 0 OID 16413)
-- Dependencies: 196
-- Data for Name: sprintUserStories; Type: TABLE DATA; Schema: process; Owner: postgres
--

INSERT INTO "sprintUserStories" VALUES (1, 1, 1);
INSERT INTO "sprintUserStories" VALUES (2, 1, 2);
INSERT INTO "sprintUserStories" VALUES (3, 1, 3);


--
-- TOC entry 2288 (class 0 OID 16418)
-- Dependencies: 198
-- Data for Name: sprints; Type: TABLE DATA; Schema: process; Owner: postgres
--

INSERT INTO sprints VALUES (1, 'New Sprint', '2017-10-01', '2017-10-31', 1);
INSERT INTO sprints VALUES (2, 'New Sprint VSCode', '2017-10-01', '2017-10-31', 2);


--
-- TOC entry 2290 (class 0 OID 16423)
-- Dependencies: 200
...
--
-- TOC entry 2305 (class 0 OID 16683)
-- Dependencies: 215
-- Data for Name: taskPoints; Type: TABLE DATA; Schema: process; Owner: postgres
--

INSERT INTO "taskPoints" VALUES (2, '2017-10-04', 5);


--
-- TOC entry 2292 (class 0 OID 16428)
-- Dependencies: 202
-- Data for Name: tasks; Type: TABLE DATA; Schema: process; Owner: postgres
--

INSERT INTO tasks VALUES (6, 1, 'Testing 3', NULL, NULL, 0, 1, 0, 5, 0);
INSERT INTO tasks VALUES (7, 3, 'Testing 4', NULL, NULL, 0, 1, 0, 4, 0);
INSERT INTO tasks VALUES (8, 1, 'Testing 6', NULL, NULL, 0, 0, 0, 1, 0);
INSERT INTO tasks VALUES (9, 1, 'Testing 5', NULL, NULL, 0, 2, 0, 5, 0);
INSERT INTO tasks VALUES (4, 1, 'Testing', NULL, NULL, 1, 1, 0, 5, 0);
INSERT INTO tasks VALUES (12, 2, 'Testing 9', NULL, NULL, 0, 1, 0, 5, 0);
INSERT INTO tasks VALUES (11, 3, 'Testing 8', NULL, NULL, 0, 1, 0, 4, 0);
INSERT INTO tasks VALUES (16, 1, 'Testing 13', NULL, NULL, 0, 1, 0, 5, 0);
INSERT INTO tasks VALUES (10, 1, 'Testing 7', NULL, NULL, 1, 0, 0, 10, 0);
INSERT INTO tasks VALUES (5, 1, 'Testing 2', NULL, NULL, 0, 1, 0, 5, 0);
INSERT INTO tasks VALUES (14, 2, 'Testing 11', 'Testing 11 task edition.', NULL, 0, 2, 0, 5, 0);
INSERT INTO tasks VALUES (15, 3, 'Testing 12', 'Testing 12 edition successful.', NULL, 0, 2, 0, 7, 0);
INSERT INTO tasks VALUES (13, 2, 'Testing 10', NULL, NULL, 0, 1, 0, 5, 0);


--
-- TOC entry 2303 (class 0 OID 16640)
-- Dependencies: 213
...
INSERT INTO "userStories" VALUES (3, 'User story 2 from DB', 'Testing new user stories', 1, 7, 1);


--
-- TOC entry 2304 (class 0 OID 16663)
-- Dependencies: 214
...
--
-- TOC entry 2294 (class 0 OID 16433)
-- Dependencies: 204
...
--
-- TOC entry 2295 (class 0 OID 16436)
-- Dependencies: 205
...
--
-- TOC entry 2298 (class 0 OID 16443)
-- Dependencies: 208
...
--
-- TOC entry 2299 (class 0 OID 16446)
-- Dependencies: 209
...
--
-- TOC entry 2300 (class 0 OID 16449)
-- Dependencies: 210
-- Data for Name: users; Type: TABLE DATA; Schema: profile; Owner: postgres
--

INSERT INTO users VALUES (0, 'admin', 'Master', 'Administrator', 'test@gmail.com', true);
INSERT INTO users VALUES (1, 'cful', 'Carlos', 'Ful', 'test@hotmail.com', false);
INSERT INTO users VALUES (2, 'lrojas', 'Liss ', 'Rojas', 'test2@hotmail.com', false);
...
SELECT pg_catalog.setval('sprint_user_stories_id_seq', 22, true);
...
SELECT pg_catalog.setval('sprints_id_seq', 2, true);
...
SELECT pg_catalog.setval('user_stories_id_seq', 31, true);
...
--
-- TOC entry 2109 (class 2606 OID 16471)
...
--
-- TOC entry 2111 (class 2606 OID 16473)
...
--
-- TOC entry 2119 (class 2606 OID 16479)
...
--
-- TOC entry 2121 (class 2606 OID 16481)
...
--
-- TOC entry 2143 (class 2606 OID 16688)
...
--
-- TOC entry 2123 (class 2606 OID 16483)
...
--
-- TOC entry 2137 (class 2606 OID 16647)
...
--
-- TOC entry 2141 (class 2606 OID 16667)
...
--
-- TOC entry 2127 (class 2606 OID 16493)
...
--
-- TOC entry 2135 (class 2606 OID 16497)
...
--
-- TOC entry 2144 (class 2606 OID 16498)
...
--
-- TOC entry 2147 (class 2606 OID 16508)
...
--
-- TOC entry 2148 (class 2606 OID 16518)
...
--
-- TOC entry 2160 (class 2606 OID 16689)
...
--
-- TOC entry 2149 (class 2606 OID 16523)
...
--
-- TOC entry 2150 (class 2606 OID 16528)
...
--
-- TOC entry 2151 (class 2606 OID 16533)
...
--
-- TOC entry 2152 (class 2606 OID 16538)
...
--
-- TOC entry 2159 (class 2606 OID 16653)
...
--
-- TOC entry 2158 (class 2606 OID 16678)
...
--
-- TOC entry 2157 (class 2606 OID 16668)
...
--
-- TOC entry 2153 (class 2606 OID 16558)
...
--
-- TOC entry 2154 (class 2606 OID 16563)
...
--
-- TOC entry 2155 (class 2606 OID 16568)
...
--
-- TOC entry 2156 (class 2606 OID 16573)
...
-- Completed on 2017-10-15 23:28:04
